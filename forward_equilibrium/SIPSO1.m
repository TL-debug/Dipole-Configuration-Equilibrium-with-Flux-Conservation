...
indR1 = floor((1.0 - R(1,1))/dr) + 1;indR2 = floor((4.0 - R(1,1))/dr) + 1;
indZ1 = floor((-0.5 - Z(1,1))/dz) + 1;indZ2 = floor((2 - Z(1,1))/dz) + 1;
...
Posep = Posepc;
% ---- 内分界面位置通量
Mo = contourc(R(:,1)',Z(1,:),tmp_psi',[psi_sepo,psi_sepo] - 2e-6);
